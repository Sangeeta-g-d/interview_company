# Generated by Django 4.1.7 on 2023-12-04 08:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company', '0015_agencyjobdetails_agency_id'),
    ]

    operations = [
        migrations.CreateModel(
            name='AgencyAppliedJobs',
            fields=[
                ...
                ('job_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.agencyjobdetails')),
